...
We have developed a novel integrative phasing method that is a framework to solve phasing jointly using different sequencing datasets and the same is presented in this section.
